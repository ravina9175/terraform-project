...
module "security_group" {
 ...
 ec2_sg_name         = "SG for EC2 to enable SSH(22), HTTPS(443),HTTP(8080)"
...
module "vpc_endpoint" {
 source            = "./vpc-endpoint"
 vpc_id            = module.networking.dev_proj_1_vpc_id
 service_name      = "com.amazonaws.eu.west-1.s3"  #service name
...
module "ec2-public-subnet" {
 ...
 subnet_id = tolist(module.networking.dev_proj_1_private_subnet_ids)[0]
 sg_for_jenkins =[module.security_group.sg_ssh_http_id, module.security_group.sg_ec2_jenkins_port_8080]
